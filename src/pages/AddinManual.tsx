    ...
    return (
        <Layout pageId="addinmanual">
            <div className="sectionmanual">
                ...
                <img
                    src="assets/images/DialogueBox1.gif"
                    width={1273}
                    height={520}
                    alt="Dialogue Box."
                />
                ...
                <img
                    src="assets/images/multitoggle.gif"
                    width={240}
                    height={232}
                ...
                <img
                    src="assets/images/DialogueBox2.gif"
                    width={1144}
                    height={744}
                    alt="Dialogue Box."
                />
                ...
                <img
                    src="assets/images/SelectQCB.gif"
                    width={1336}
                    height={1050}
                ...
                <img
                    src="assets/images/EditCustom.gif"
                    width={1336}
                    height={300}
                    alt="Dialogue Box."
                />
